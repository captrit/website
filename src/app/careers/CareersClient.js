              ...
              {isLoading ? (
                ...
                >
                  ...
                  <div className="bg-gradient-to-r from-brand-50 to-brand-100/50 border border-brand-200 rounded-2xl p-6 max-w-2xl mx-auto">
                    <p className="text-brand-600 mb-4 text-center">
                      We're not hiring right now.<br />
                      Send your resume to <a href="mailto:career@captrit.ae" className="underline text-brand-700 hover:text-brand-900">career@captrit.ae</a>
                    </p>
                  </div>
                </motion.div>
