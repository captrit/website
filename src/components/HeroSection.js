    ...
    <section className="relative flex flex-col items-center justify-center min-h-screen overflow-hidden bg-background-primary">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 text-center">
        ...
        <h1 className={`text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black leading-[1.1] sm:leading-[1.05] mb-6 sm:mb-8 transition-all duration-1000 delay-200 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <span className="block text-text-primary">Your External</span>
          <span className="block bg-gradient-to-r from-brand-600 to-brand-400 bg-clip-text text-transparent">Security</span>
          <span className="block text-text-primary">Engineering Team</span>
        </h1>
        ...
        <p className={`text-lg sm:text-xl md:text-2xl lg:text-3xl text-text-secondary mb-8 sm:mb-12 max-w-3xl mx-auto leading-relaxed transition-all duration-1000 delay-400 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <span className="text-text-accent font-semibold text-base sm:text-lg md:text-xl lg:text-2xl">For SaaS Startups, Dev Teams & IT Partners</span><br />
          <span className="text-text-secondary text-base sm:text-lg md:text-xl lg:text-2xl">dev-first, battle-tested security solutions</span>
        </p>
        ...
        <div className={`transition-all duration-1000 delay-600 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          >
            ...
            Start Your Free Attack Surface Discovery
            </span>
          </a>
        </div>
      </div>
